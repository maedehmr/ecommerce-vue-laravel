            ...
            <div class="allTable">
                <div class="allTopTable">
                    <div class="allTopTableItem">
                        <div class="postContentOptionsItem" @click="btnRemoveArray(0)" v-if="value.length && deletes == 1">حذف</div>
                    </div>
                    <div class="allTopTableItem">
                ...
                <transition name="slide-fade">
                    <div class="allTableContainer" v-if="getPosts == ''">
                        <all-table :table="posts.data" :nameTable="'news'" :labels="labels" :deletes="deletes" :shows="0" v-on:sendCheck="getCheck" :edits="edits" v-on:sendDelete="btnRemoveArray"></all-table>
                    </div>
                </transition>
                <div class="paginate" v-if="getPosts == ''">
                    <paginate-panel :link="posts.links"></paginate-panel>
...
export default {
    ...
    methods:{
        ...
        sidebars(){
            this.$eventHub.emit('sidebar' , [10,42]);
        },
        sendStatus(number){
