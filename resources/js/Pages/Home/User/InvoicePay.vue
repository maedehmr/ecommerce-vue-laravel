                    ...
                    <td style="height: 2cm;vertical-align: center; padding: 0 4px 4px">
                        <div class="bordered header-item-data">
                            <table class="centered" style="height: 100%">
                                ...
                                <tr>
                                    <td colspan="4" v-if="pay.user.user_meta.length">
                                        <span class="label">نشانی:</span>{{pay.user.user_meta[0].address}}
                                    </td>
                                </tr>
                                <tr v-if="pay.user.user_meta.length">
                                    <td colspan="2">
                                        <span class="label">شماره تماس:</span> {{pay.user.number}}
                                    </td>
                                    <td colspan="2">
                                        <span class="label">کد پستی:</span> {{pay.user.user_meta[0].post}}
                                    </td>
                                </tr>
                            </table>
                        </div>
