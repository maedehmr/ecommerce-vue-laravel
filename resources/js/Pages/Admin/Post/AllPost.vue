            ...
            <div class="allTable">
                ...
                <transition name="slide-fade">
                    <div class="allTableContainer" v-if="getPosts == ''">
                        <all-table :table="posts.data" :nameTable="'post'" :labels="labels" :deletes="deletes" :shows="shows" v-on:sendCheck="getCheck" :edits="edits" v-on:sendDelete="btnRemoveArray"></all-table>
                    </div>
                </transition>
                <div class="paginate">
                    <paginate-panel :link="posts.links"></paginate-panel>
                ...
                <transition name="slide-fade">
                    <div class="createPostPanel" v-if="getPosts">
                        ...
                        <div class="allCreatePostItems">
                            ...
                            <div class="allCreatePostItem">
                                <label>گارانتی</label>
                                <input v-model="form.guarantee" type="text" placeholder="گارانتی را وارد کنید">
                            </div>
                            <div class="allCreatePostItem">
                ...
                <div class="allShowFastPostPanel">
                    ...
                    <div class="allShowFastPostItems" v-if="showPost.post_meta[0].ability != null">
                        ...
                        <div class="allShowFastPostProperties">
                            <ul v-if="showPost.post_meta[0].ability != null">
                                <li v-for="(items,index) in JSON.parse(showPost.post_meta[0].ability).slice(0 , 3)" :key="index">
                                    <span>{{items.name}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="allShowFastPostItems" v-if="showPost.color.length">
                        <div class="allShowFastPostItemsTitle">
                            <h3>رنگ های محصول</h3>
                        </div>
                        <div class="allShowFastPostProperties">
                            <ul>
                                <li v-for="(items,index) in showPost.color" :key="index">
                                    <span>{{items.name}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="allShowFastPostItems" v-if="showPost.size.length">
                        <div class="allShowFastPostItemsTitle">
                            <h3>سایز های محصول</h3>
                        </div>
                        <div class="allShowFastPostProperties">
                            <ul>
                                <li v-for="(items,index) in showPost.size" :key="index">
                                    <span>{{items.name}}</span>
                                </li>
                            </ul>
                        </div>
...
export default {
    ...
    methods:{
        ...
        openEdit(id){
            ...
            this.$inertia.post(url,{
                ...
                .then(response=>{
                    ...
                    this.form.body = this.getPosts.post_meta[0].body;
                    this.form.titleEn = this.getPosts.post_meta[0].titleEn;
                    this.form.guarantee = this.getPosts.post_meta[0].guarantee;
                    this.form.count = this.getPosts.count;
                    this.form.summery = this.getPosts.summery;
        ...
        sidebar(){
            this.$eventHub.emit('sidebar' , ['2','4']);
        },
        sendType(number){
